...
const Blog = () => {
    ...
    <header>
    <h1 className="text-center mt-5 mb-5"> This is the blog page </h1>
    </header>
        ...
        <div className="parallax">
            ...
            <div className="parallax-back">
                <div className="card h-100">
                    <img src="http://www.ijailbreak.com/wp-content/uploads/2012/09/NatGeo17.jpg" className="card-img-top" alt="Yosemite Wallpaper"/>
